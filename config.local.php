...
$config['db_name'] = 'eshopsup_shop';
$config['db_user'] = 'eshopsup_sa';
$config['db_password'] = '9Ei,k9K+G8op';
...
$config['http_host'] = 'eshop.supercourse.gr';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'eshop.supercourse.gr';
$config['https_path'] = '';
...
$config['admin_index']    = 'admin23F.php';
...
if ('37.6.222.189'==$_SERVER['REMOTE_ADDR']) {
