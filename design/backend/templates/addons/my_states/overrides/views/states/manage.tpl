...
<tr>
    ...
    <th width="55%">{__("state")}</th>
    <th width="5%">{__("cmp")}</th>
    <th width="5%">&nbsp;</th>
...
<tr class="cm-row-status-{$state.status|lower}">
    ...
    <td>
        <input type="text" name="states[{$state.state_id}][state]" size="50" value="{$state.state}" class="input-hidden span7"/></td>
	<td>
        <input type="text" name="states[{$state.state_id}][cmp]" size="2" value="{$state.cmp}" class="input-hidden span1"/></td>
    <td class="nowrap">
...
{capture name="tools"}
    ...
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
            <input type="text" id="elm_state_name" name="state_data[state]" size="50" value="" />
            </div>
        </div>
		
		<div class="control-group">
            <label class="control-label" for="elm_state_cmp">{__("cmp")}:</label>
            <div class="controls">
            <input type="text" id="elm_state_cmp" name="state_data[cmp]" size="2" value="" />
            </div>
        </div>
