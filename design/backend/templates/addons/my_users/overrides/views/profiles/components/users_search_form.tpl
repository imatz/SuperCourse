...
<div class="sidebar-field">
    <label for="elm_user_login">{__("customer_code")}</label>
    <div class="break">
...
<!--Text field gia to sidebar to opoio einai sti lista pelatwn nikosgkil -->
<div class="sidebar-field">
    <label for="elm_email">{__("fmail")}</label>
    <div class="break">
        <input type="text" name="fmail" id="elm_fmail" value="{$search.fmail}" />
    </div>
</div>
<!--nikosgkil-->
