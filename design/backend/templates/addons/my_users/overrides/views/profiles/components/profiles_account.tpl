...
<!--<div> gia emfanisi text pediou gia to fmail sti selida tou kathe pelati. - nikosgkil-->
<div class="control-group">
    <label for="fmail" class="control-label cm-required cm-email">{__("fmail")}:</label>
    <div class="controls">
        <input type="text" id="fmail" name="user_data[fmail]" class="input-large" size="32" maxlength="128" value="{$user_data.fmail}" />
    </div>
</div>
<!--nikosgkil-->
