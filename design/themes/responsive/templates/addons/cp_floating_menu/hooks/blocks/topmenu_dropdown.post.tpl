    ...
    $(window).scroll(function () {
        if ($(window).width() > 767) {     
            if ($(window).scrollTop() < 90) {
                ...
                $('#cp_f_menu').css('background', '#34495e');
...
{if $items}
<div id="cp_f_menu" style="position: fixed; top:-50px; left:0; right: 0; z-index: 998; text-align: center; background: #ffffff; display: none; box-shadow: 0 1px 4px -1px rgba(0,0,0,0.7); height: 46px;">
