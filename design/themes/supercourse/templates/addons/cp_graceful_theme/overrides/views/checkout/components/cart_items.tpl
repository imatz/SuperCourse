...
<div id="cart_items">
    ...
    <thead>
	    ...
	    {* nikosgkil *}
	    <th class="ty-cart-content__title ty-center">{__("retail_price")}</th>
	    {* nikosgkil *}
            <th class="ty-cart-content__title quantity-cell ty-center">{__("quantity")}</th>
            <th class="ty-cart-content__title ty-center">{__("total_price")}</th>
        </tr>
    </thead>
