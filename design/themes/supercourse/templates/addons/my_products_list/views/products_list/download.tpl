<div id="content_products_list">
	...
	{include file="buttons/button.tpl" but_text=__("download_images") but_href="products_list.images" but_meta="ty-btn__secondary"}
</div>

{capture name="mainbox_title"}{__("download_product_list")}{/capture}
