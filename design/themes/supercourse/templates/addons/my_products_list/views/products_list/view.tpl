	...
	<script>
		$(document).ready(function(){
			...
			$('.add-btn').click(function(){
				$('#products_list_tbl tbody').append('<tr><td><input type="text" name="product_list['+ products_list_tbl_cnt +'][A]"></td><td><input type="text"  size="5" class="cm-value-integer" name="product_list['+ products_list_tbl_cnt +'][B]"></td><td><a class="ty-btn ty-btn__secondary del-btn">-</a></td></tr>');
