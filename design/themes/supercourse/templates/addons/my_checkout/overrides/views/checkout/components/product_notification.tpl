...
<div class="center">
	...
	<div class="ty-float-left my_cart_continue" >
        {include file="buttons/button.tpl" but_text=__("continue_shopping_mini") but_meta="ty-btn__secondary cm-notification-close" }
    </div>
