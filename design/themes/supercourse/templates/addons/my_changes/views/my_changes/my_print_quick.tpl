...
<br>
<br>
{$prod_id = $prod_pack_id}
{$smarty.post.$prod_id}
{include file="buttons/button.tpl" but_text=__("print_code") but_name="dispatch[my_changes.my_print.$prod_id]" but_role="select" but_meta="cm-new-window ty-btn__secondary"}
