...
<div class="ty-float-left ty-package-products-search-form-left-block">
...
<div class="ty-float-right ty-package-products-search-form-right-block">
<div class="ty-control-group">
    ...
    <div class="ty-float-left">{* dont delete this div. its really needed! *}
        {assign var="all_categories" value=0|fn_my_picker_plain_categories_tree}
        <select name="cid">
...
<div class="ty-package-products-search-form__buttons-container buttons-container">
...
{/capture}
{include file="addons/my_product_packages/common/open_section.tpl" section_title=__("search_options") section_content=$smarty.capture.section class="ty-package-products-search-form"}
