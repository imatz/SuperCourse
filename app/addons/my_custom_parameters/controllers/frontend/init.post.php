...
if ('erp_sync'!=$controller && !('auth'==$controller && ('login_form'==$mode || 'login'==$mode || 'recover_password'==$mode)) 
							&& !('my_changes'==$controller && ('my_info'==$mode || 'login2'==$mode || 'login3'==$mode|| 'my_pass'==$mode))
							&& !('profiles'==$controller && ('retail'==$mode || 'add'==$mode || 'register'==$mode|| 'success_register'==$mode))) {
