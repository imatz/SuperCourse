...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
	...
	if ($mode == 'login2') 
	{
		...
		$password = db_get_field("SELECT password FROM j89517laso_supercou_bridge26S.customer WHERE j89517laso_supercou_bridge26S.customer.Code = '$customer_code'");
	...
	if($mode == 'login3')
	{
		...
		$redirect_url = '';
			...
			//fn_print_die($u_data);
			// fernei to pass apo th gefyra - nikosgkil
			$password = db_get_field("SELECT password FROM j89517laso_supercou_bridge26S.customer WHERE j89517laso_supercou_bridge26S.customer.Code = '$user_login1'");
