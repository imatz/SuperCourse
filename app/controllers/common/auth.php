...
//
if ($mode == 'logout') {
	// adeiazo to fmail molis o xristis kanei logout gia na min exei ksana prosvasi sto my_changes.my_emails - nikosgkil
	$fmail = '';
	...
	// prosthesa to redirect - nikosgkil
	$redirect_url = 'index.php';
	fn_redirect($redirect_url, true);
	// redirect diko mou apo pano - nikosgkil
